  ...
  return (
    <section className="bg-black px-6 py-28 sm:px-10 md:px-16 lg:px-24 lg:py-36">
      <div className="mx-auto max-w-6xl">
        <div className="grid items-center gap-14 rounded-[2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-6 shadow-[0_0_60px_rgba(255,255,255,0.03)] sm:p-8 md:gap-20 md:p-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:p-14">
